  ...
  return (
    <div>
      <div className='p-2 mt-5 flex flex-col items-center'>
        ...
        <button onClick={ () => createObservation() } className='mt-5 px-4 py-1 text-lg text-white bg-green-600 hover:bg-green-800 border-transparent font-semibold rounded-full border border-green-200  focus:outline-none'>Submit</button>
      </div>
    </div>
  );
}
